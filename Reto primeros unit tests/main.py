...
# Prueba
greeter = Greeter()
print(greeter.greet(" Diego "))  # imprime: "Buenos días Diego"
print(greeter.greet("Denisse"))   # imprime: "Buenas tardes Denisse"
print(greeter.greet("Cristofer"))     # imprime: "Buenas noches Cristofer"